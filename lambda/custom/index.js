...
const GetInventoryIntentHandler = {
  canHandle(handlerInput) {
    return handlerInput.requestEnvelope.request.type === 'IntentRequest'
  ...
  async handle(handlerInput) {
    ...
    const product = await api.getProduct(productName);
    
    const speechText = `The product ${product.name} was found in ${product.room} and costs ${product.price}`;
    return handlerInput.responseBuilder
      .speak(speechText)
      .withSimpleCard('Hello World', speechText)
      .getResponse();
